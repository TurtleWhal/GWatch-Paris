...
LV_FONT_DECLARE(SirinStencil_64);
...
#define SET_SYMBOL__64(obj, sym) lv_obj_set_style_text_font(obj, &SirinStencil_64, LV_PART_MAIN); lv_label_set_text(obj, sym);

#define FA_STEPS          "" // '', Sizes: [14, 28, 22]
