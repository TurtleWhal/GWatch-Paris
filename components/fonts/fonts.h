...
#define SET_SYMBOL_old_76(obj, sym) lv_obj_set_style_text_font(obj, &ProductSansBold_76, LV_PART_MAIN); lv_label_set_text(obj, sym);
#define SET_SYMBOL_old_92(obj, sym) lv_obj_set_style_text_font(obj, &ProductSansBold_92, LV_PART_MAIN); lv_label_set_text(obj, sym);
